...
@app.get("/root/{p_id}")          #-> path parameter(p_id) #->quary parameter no need to mention path parameter side
def fun(p_id : int ,id:int, page:Union[int, None] = None):  #-> p_id int path parameter --> ? id =int  --> ? page not mentioned default value null worked
